...
// Imporatnat use cases of Stack (Stack application)
// Dhyana se dekho toh yaha Stack ka use case kya hai ??
// Voh yeh keh raha hai ki bhai tumhe answer chahiye?? tum dekho answer mere andr hi pade huya hai
// Answers ka track maintain rakh raha hai
// To reduce the O(n) complexity
...
vector<int> nextSmaller(int *arr, int n){
    ...
    for (int i = n - 1; i >= 0; i--){
        ...
        // yaha parr ab aapko curr se chota element mill chuka hai
